  ...
  return (
    ...
    >
      ...
      <div className=" relative w-screen h-[50%] flex flex-col justify-center items-center">
        ...
        <h3 className=" text-lg  md:text-[1.71rem] w-[50%] text-center font-bold text-white z-10 mt-2">
          We&apos;re here to help you reach your goal and reach your full
          potential.
        </h3>
        <p className="hidden md:block text-md w-[60%] text-center text-white z-10 mt-2">
